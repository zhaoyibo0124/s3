        ...
        <div class="gutter-box">
            ...
            <a-card v-if="operation.table">
                ...
                <a-table :columns="columns" :dataSource="dataSource" :loading="tableLoading"
                    :rowKey="(record) => { return record.id }" :pagination="tablePagination" :scroll="{ x: 1200 }">
...
export default {
    ...
    methods: {
        ...
        queryListData(page, pageSize) {
            ...
            timeRexQueryListApi(data).then(res => {
                // 全局loading隐藏
        ...
        deleteBtn(record) {
            ...
            this.$confirm({
                ...
                onOk() {
                    ...
                    timeRexDeleteApi(data).then(res => {
                        const data = res.data
                        if (data.code == 200) {
        ...
        disableBtn(record) {
            ...
            this.$confirm({
                ...
                onOk() {
                    ...
                    timeRexDisableApi(data).then(res => {
                        const data = res.data
                        if (data.code == 200) {
                            if (that.operation.queryList) {
                                that.queryListData(that.tablePagination.defaultCurrent, that.tablePagination.defaultPageSize)
        ...
        restoreBtn(record) {
            ...
            this.$confirm({
                ...
                onOk() {
                    ...
                    timeRexRecoveryApi(data).then(res => {
                        const data = res.data
                        if (data.code == 200) {
                            if (that.operation.queryList) {
                                that.queryListData(that.tablePagination.defaultCurrent, that.tablePagination.defaultPageSize)
