<template>
	...
	>
		...
		>
			...
			<a-form-model-item label="文件路径" prop="filePath">
				<a-input v-model="form.filePath" placeholder="请输入" :disabled="title == '查看'" />
			</a-form-model-item>
			<a-form-model-item label="文件排序" prop="fileSort">
				<a-input-number style="width: 100%" :min="0" :max="9999" v-model="form.fileSort" placeholder="请输入" :disabled="title == '查看'" />
			</a-form-model-item>
			<a-form-model-item label="文件备住" prop="fileContent">
				<a-textarea rows="4" v-model="form.fileContent" placeholder="请输入" :disabled="title == '查看'"/>
			</a-form-model-item>
		</a-form-model>
	</a-modal>
</template>
    ...
    data() {
      return {
				...
				form: {
					...
					fileContent: this.defaultData.data.fileContent?this.defaultData.data.fileContent:'',
					fileSort: this.defaultData.data.fileSort?this.defaultData.data.fileSort:'',
				},
				rules: {
					filePath: [
					...
					if(valid){
						if(this.title == '新增'){
							const data = {
								...
								fileSort: this.form.fileSort,
							}
							FileAdd(data).then(res => {
