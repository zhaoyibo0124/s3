<template>
	...
	>
		...
		>
			<a-form-model-item label="功能编码" prop="operationCode">
				<a-input v-model="form.operationCode" placeholder="请输入" :disabled="title == '查看'" />
			</a-form-model-item>
			<a-form-model-item label="功能名称" prop="operationName">
				<a-input v-model="form.operationName" placeholder="请输入" :disabled="title == '查看'" />
			</a-form-model-item>
			<a-form-model-item label="功能排序" prop="operationSort">
				<a-input-number style="width: 100%" :min="0" :max="9999" v-model="form.operationSort" placeholder="请输入" :disabled="title == '查看'" />
			</a-form-model-item>
			<a-form-model-item label="功能备住" prop="operationContent">
				<a-textarea rows="4" v-model="form.operationContent" placeholder="请输入" :disabled="title == '查看'"/>
			</a-form-model-item>
		</a-form-model>
	</a-modal>
</template>
    ...
    data() {
      return {
				...
				form: {
					...
					operationCode: this.defaultData.data.operationCode?this.defaultData.data.operationCode:'',
					operationName: this.defaultData.data.operationName?this.defaultData.data.operationName:'',
					operationContent: this.defaultData.data.operationContent?this.defaultData.data.operationContent:'',
					operationSort: this.defaultData.data.operationSort?this.defaultData.data.operationSort:'',
				},
				rules: {
					operationCode: [
					...
					if(valid){
						if(this.title == '新增'){
							const data = {
								...
								operationContent: this.form.operationContent,
								operationSort: this.form.operationSort,
							}
							OperationAdd(data).then(res => {
