					...
					<a-form-model layout="inline" ref="ruleForm" :model="searchForm">
						...
						<a-form-model-item>
							<span style="display: inline-block;">
								...
								<a-button style="margin-left: 8px" @click="handleClean">清除</a-button>
...
<script>
	...
	import infoAlert from '@/pages/form/operation/operation'
	import {
	...
	export default {
		...
		methods: {
			...
			handleReset() {
				...
				this.tablePagination.pages = 0
			},
			// 清除
			handleClean() {
				var formId = this.searchForm.formId
				this.searchForm = {}
