...
export default {
    ...
    data() {
        ...
        return {
            ...
            columns: [
                ...
                {
                    title: '截断规则',
                    dataIndex: 'truncationRule',
                    ellipsis: true,
                    width: 160,
                    customRender: (text, record) => <a-tooltip placement="topLeft" title={record.truncationRule}>{record.truncationRule}</a-tooltip>
                },
                {
                    title: '替换规则',
    ...
    methods: {
        ...
        queryListData(page, pageSize) {
            ...
            generalQueryListApi(data).then(res => {
                // 全局loading隐藏
        ...
        deleteBtn(record) {
            ...
            this.$confirm({
                ...
                onOk() {
                    ...
                    generalDeleteApi(data).then(res => {
                        const data = res.data
                        if (data.code == 200) {
        ...
        disableBtn(record) {
            ...
            this.$confirm({
                ...
                onOk() {
                    ...
                    generalDisableApi(data).then(res => {
                        const data = res.data
                        if (data.code == 200) {
                            if (that.operation.queryList) {
                                that.queryListData(that.tablePagination.defaultCurrent, that.tablePagination.defaultPageSize)
        ...
        restoreBtn(record) {
            ...
            this.$confirm({
                ...
                onOk() {
                    ...
                    generalRecoveryApi(data).then(res => {
                        const data = res.data
                        if (data.code == 200) {
                            if (that.operation.queryList) {
                                that.queryListData(that.tablePagination.defaultCurrent, that.tablePagination.defaultPageSize)
