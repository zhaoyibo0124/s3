<template>
  <div class="page-layout">
    <!-- <page-header ref="pageHeader" :style="`margin-top: ${multiPage ? 0 : -24}px`" :breadcrumb="breadcrumb" :title="pageTitle" :logo="logo" :avatar="avatar"> -->
		<page-header ref="pageHeader" :style="`margin-top: ${multiPage ? 0 : -24}px`" :breadcrumb="breadcrumb" :title="pageTitle" :logo="logo">
...
export default {
  ...
  // props: ['desc', 'logo', 'title', 'avatar', 'linkList', 'extraImage'],
	props: ['desc', 'logo', 'title', 'linkList', 'extraImage'],
  data () {
    return {
      page: {},
      pageHeaderHeight: 0,
